    ...
    <div class="register-photo">
        <div class="form-container">
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="">Last Name</label><input name="lastname" id="lastname" class="form-control" type="text"
                        value="{{ $user->lastname }}">
                </div>
                <div class="form-group">
                    <label for="">Age</label><input name="age" id="age" class="form-control" type="number"
                        value="{{ $user->age }}">
                </div>
                <div class="form-group">
