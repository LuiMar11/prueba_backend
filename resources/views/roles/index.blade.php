                            ...
                            <tbody class="text-center">
                                @foreach ($roles as $rol)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="{{ route('roles.show', $rol->id) }} "><i
                                                    class="fas fa-eye"></i></a>
                                        </td>
                                        <td>
                                            <a class="btn btn-success" href="{{ route('roles.edit', $rol->id) }} "><i
                                        ...
                                        <td>
                                            <form action="{{ route('roles.destroy', $rol->id) }}" method="POST">
                                                ...
                                                <button class="btn btn-danger" type="submit"
                                                    onclick="return confirm('¿Desea eliminar el rol?')"><i
